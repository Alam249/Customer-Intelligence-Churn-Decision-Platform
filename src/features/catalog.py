...
FEATURE_CATALOG: list[dict[str, str]] = [
    ...
    {
        "name": "avg_interpurchase_days / std_interpurchase_days",
        "stage": "SQL (Step 3)",
        "category": "Customer history",
    ...
    {
        "name": "total_items / avg_items_per_order",
        "stage": "SQL (Step 3)",
        "category": "Monetary",
    ...
    # --- Returns (SQL, Step 3) ---
    {
        "name": "return_invoices / return_value / return_rate",
        "stage": "SQL (Step 3)",
        "category": "Behavioral",
    ...
    # --- NEW in Step 6: row-wise derived features ---
    {
        ...
        "stage": "Feature engineering (Step 6)",
        "category": "Monetary",
